function SCEPTAR(monitor, maxima, minima){
    ...
    //insert nav link
    insertButton('SCEPTARlink', 'navLink', "javascript:swapFade('SCEPTARCanvas', 'SCEPTARlink', window.SCEPTARpointer, window.subsystemScalars)", this.linkWrapperID, 'SCEPTAR');
