function configure(detector){
	if(detector == 'SHARC'){
		...
		//SPICE aux info only needed when SPICE aux may be deployed (ie TIGRESS or GRIFFIN when S2/S3 selected for DSC)
		if(window.experiment == 'TIGRESS' || (ODBGet('/DashboardConfig/BAMBINO/USdeploy')!=1 && ODBGet('/DashboardConfig/BAMBINO/DSdeploy')==1) ){
			//S2 or S3 auxiliary:
